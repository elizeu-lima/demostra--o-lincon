...
export class ChatService
{
    ...
    private apiUrl = 'https://s1n1.squidchat.digital/api/v1/bdtec/contatos/menu/auto-atendimento';
    ...
    getFuseRand(): Observable<Chat[]>{
        return this._httpClient.get<Chat[]>(this.apiUrl);
    }
}
